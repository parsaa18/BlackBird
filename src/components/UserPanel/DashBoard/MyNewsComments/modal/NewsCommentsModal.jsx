...
const NewsCommentModal = ({ commentList, isOpen, setOpen }) => {
	return (
		<Modal
			isOpen={isOpen}
			onClose={() => {
		...
		>
			<div className="h-[440px]  px-3 flex flex-col gap-5 overflow-hidden">
				<div className="flex items-center justify-between">
					<h3 className="text-2xl font-medium text-metricBlack">
						کامنت های بلاگ
					</h3>
					<p
						className="cursor-pointer text-metricBlack "
						onClick={() => {
							setOpen(false);
						}}
					>
...
export default NewsCommentModal;
